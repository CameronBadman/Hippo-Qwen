...
def main() -> None:
    ...
    parser.add_argument("--skeleton-dims", type=int, default=128)
    parser.add_argument("--skeleton-segments", type=int, default=16)
    parser.add_argument("--skeleton-segment-limit", type=int, default=96)
    ...
    parser.add_argument("--skeleton-final-fetch", type=int, default=96)
